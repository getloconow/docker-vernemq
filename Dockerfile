...
COPY --chown=10000:10000 files/custom.lua /vernemq/share/lua/auth/custom.lua
COPY --chown=10000:10000 files/base64.lua /vernemq/share/lua/base64.lua
RUN mkdir /vernemq/share/lua/auth/luajwt && chown -R 10000:10000 /vernemq/share/lua/auth/luajwt
COPY --chown=10000:10000 files/luajwt.lua /vernemq/share/lua/auth/luajwt/luajwt.lua
